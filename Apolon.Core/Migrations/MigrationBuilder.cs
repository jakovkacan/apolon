...
public sealed class MigrationBuilder
{
    ...
    public void AddColumn(
        ...
        => _ops.Add(new MigrationOperation(
            ...
            Column: column, SqlType: sqlType, IsNullable: isNullable,
    ...
    public void DropColumn(string schema, string table, string column)
        => _ops.Add(new MigrationOperation(MigrationOperationType.DropColumn, schema, table, Column: column));

    public void AlterColumnType(string schema, string table, string column, string sqlType)
        => _ops.Add(new MigrationOperation(MigrationOperationType.AlterColumnType, schema, table, Column: column,
            SqlType: sqlType));

    public void AlterNullability(string schema, string table, string column, bool isNullable)
        => _ops.Add(new MigrationOperation(MigrationOperationType.AlterNullability, schema, table, Column: column,
            IsNullable: isNullable));

    public void SetDefault(string schema, string table, string column, string defaultSql)
        => _ops.Add(new MigrationOperation(MigrationOperationType.SetDefault, schema, table, Column: column,
            DefaultSql: defaultSql));

    public void DropDefault(string schema, string table, string column)
        => _ops.Add(new MigrationOperation(MigrationOperationType.DropDefault, schema, table, Column: column));

    public void AddUnique(string schema, string table, string column)
        => _ops.Add(new MigrationOperation(MigrationOperationType.AddUnique, schema, table, Column: column));
