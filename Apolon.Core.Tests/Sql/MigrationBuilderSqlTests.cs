...
public class MigrationBuilderSqlTests
{
    ...
    {
        var sql = MigrationBuilderSql.BuildDropTable(typeof(SimpleTableEntity), cascade: false);
    ...
    {
        var sql = MigrationBuilderSql.BuildDropTableFromName("public", "test_table", cascade: false);
    ...
    {
        var sql = MigrationBuilderSql.BuildAddColumn("public", "test_table", "id", "INTEGER", false, null, isPrimaryKey: true);
    ...
    {
        var sql = MigrationBuilderSql.BuildAddColumn("public", "test_table", "id", "INTEGER", false, null, isIdentity: true, identityGeneration: "ALWAYS");
    ...
    {
        var sql = MigrationBuilderSql.BuildAddColumn("public", "test_table", "id", "INTEGER", false, null, isIdentity: true, identityGeneration: "BY DEFAULT");
    ...
    {
        var sql = MigrationBuilderSql.BuildAddColumn("public", "test_table", "id", "INTEGER", false, null, isIdentity: true, identityGeneration: "BYDEFAULT");
    ...
    {
        var sql = MigrationBuilderSql.BuildAddColumn("public", "test_table", "id", "INTEGER", false, null, isIdentity: true, identityGeneration: null);
    ...
    {
        var sql = MigrationBuilderSql.BuildAddColumn("public", "test_table", "id", "INTEGER", false, null, isIdentity: true, identityGeneration: "INVALID");
    ...
    {
        var sql = MigrationBuilderSql.BuildAddColumn("public", "test_table", "id", "INTEGER", false, "1", isPrimaryKey: true, isIdentity: true, identityGeneration: "ALWAYS");

        Assert.Equal("ALTER TABLE public.test_table ADD COLUMN id INTEGER DEFAULT 1 PRIMARY KEY GENERATED ALWAYS AS IDENTITY;", sql);
    }
    ...
    public void BuildAddForeignKey_WithDefaultOnDelete_GeneratesCorrectSql()
    {
        ...
        Assert.Equal("ALTER TABLE public.orders ADD CONSTRAINT orders_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE NO ACTION;", sql);
    }
    ...
    public void BuildAddForeignKey_WithCascade_GeneratesCorrectSql()
    {
        ...
        Assert.Equal("ALTER TABLE public.order_items ADD CONSTRAINT order_items_order_id_fkey FOREIGN KEY (order_id) REFERENCES public.orders(id) ON DELETE CASCADE;", sql);
    }
    ...
    public void BuildAddForeignKey_WithSetNull_GeneratesCorrectSql()
    {
        ...
        Assert.Equal("ALTER TABLE public.posts ADD CONSTRAINT posts_author_id_fkey FOREIGN KEY (author_id) REFERENCES public.users(id) ON DELETE SET NULL;", sql);
    }
    ...
    public void BuildAddForeignKey_WithRestrict_GeneratesCorrectSql()
    {
        ...
        Assert.Equal("ALTER TABLE public.invoices ADD CONSTRAINT invoices_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES public.customers(id) ON DELETE RESTRICT;", sql);
    }
    ...
    public void BuildAddForeignKey_WithCrossSchema_GeneratesCorrectSql()
    {
        ...
        Assert.Equal("ALTER TABLE sales.orders ADD CONSTRAINT orders_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE NO ACTION;", sql);
    }
